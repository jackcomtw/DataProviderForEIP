...
public class PowerService {
    ...
    public void init() {
        ...
        log.info("PowerService init ");
        log.warn("PowerService init ");
    ...
    public void exit(){
        ...
        log.info("PowerService exit");
        log.warn("PowerService exit");
    }
}
...
enum PowerManagement {
    ...
    {
        if (!kernel32.PowerSetRequest(handle, Kernel32.PowerRequestType.PowerRequestDisplayRequired.ordinal()))
    ...
    {
        if (!kernel32.PowerClearRequest(handle, Kernel32.PowerRequestType.PowerRequestDisplayRequired.ordinal()))
